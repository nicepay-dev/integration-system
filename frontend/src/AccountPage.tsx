...
export default function AccountPage({user}:{user:{name:string;email:string;role:string}}) {
  ...
  return <main className="content account-page">
    <header><div><p className="eyebrow">ACCOUNT SECURITY</p><h1>Your account</h1><p className="muted">Manage your personal access to Nicepay Integration.</p></div></header>
